		...
		<td>
				...
				<div class="z-toolbar-ct">
					<div class="z-toolbar-overflow">
						<div class="z-toolbar-nowrap">
							...
							<a href="javascript:void(0);"  class="z-btn z-btn-flat" onclick="sendMessage();">
                                <img class="icon021a4" src="../s9/res/img/icon000.png"><b>发送模板消息<i></i></b>
                            </a>
			...
			<div class="gradient" style="padding: 5px 12px;">
				<div style="float: left;white-space:nowrap">
					...
					<input type="text" id="appid" name="appid" style="width:60px;">
					<label>公众号秘钥</label>
					<input type="text" id="secret" name="secret" style="width:60px;">
					<label>模板消息ID</label>
					<input type="text" id="templateId" name="templateId" style="width:60px;">
					用户昵称：<input type="text" id="nickname" name="nickname" value="${nicename}" style="width:30px">
					openid：<input type="text" id="openId" name="openId" value="${openId}" style="width:60px">
					省份：<input type="text" id="province" name="province" value="" style="width:30px">
					城市：<input type="text" id="city" name="city" value="" style="width:30px" style="width:30px">
					性别：
